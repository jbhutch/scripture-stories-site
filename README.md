...
- **Random** — loads a story immediately on arrival. Identical "Random
  Scripture Story" buttons above and below the story both pull a new one,
  so you can reroll without scrolling past a long summary either way. The
  label deliberately avoids referring to a previous story ("another",
  "again") because the top button is read *before* the story it sits
  above. Ticking a category swaps in a story from it right away.
